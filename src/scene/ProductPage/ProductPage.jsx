...
const ProductPage = () => {
  ...
  return (
    ...
    <div style={{flex:1,marginTop:'10px',width:'100vh',justifyContent:'center',alignItem:'center'}}>
      <div >
        <h2>Products List</h2>
      <input type="search" placeholder="Search Product" className="input-search" 
      style={{width:'50%',borderRadius:'5px',border:'1px solid #ccc' ,padding:'10px 10px', marginBottom: '0px'}}
      value={search}
